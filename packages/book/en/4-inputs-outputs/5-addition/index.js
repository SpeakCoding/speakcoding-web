...
import { Expand, Hint, Icon, Pre, Section, Structure } from '@sc/ui';
...
export default () => (
    <Section>
        <Section.Main>
            <Expand id='2-5-1' opened>
                <Section.Block>
                    <Section.Main narrow>
                        <h1>In addition (Class inheritance)</h1>
                        <p>
                ...
                <Section.Block>
                    <Section.Main narrow>
                        <p>
                            ...
                            modern programming languages require you to put the word{' '}
                            <b>“override”</b> before the inherited function to confirm the
                            replacement, or override, of this function in the child class.
                        </p>
                        <p>
