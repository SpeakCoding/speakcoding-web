    ...
    <Section.Block>
        <Section.Main>
            ...
            <p>
                ...
                <Term id='instance'>object (instance)</Term> to the function that is called when the
                Submit button is pressed. The function takes the data and performs a sequence of
                steps to create the new User.
            </p>
            <Grid cols='36% 1fr'>
