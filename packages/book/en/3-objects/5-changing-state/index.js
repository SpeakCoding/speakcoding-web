            ...
            <Section.Block>
                <Section.Main>
                    ...
                    <p>
                        ...
                        actions that we can perform with specific <Term id='instance'>objects</Term>{' '}
                        (instances) of a particular <Term id='class'>class</Term>. To change an
                        object means to change the <Term id='component'>components</Term> and{' '}
                    ...
                    <p>
                        ...
                        definition. For this <Term id='function'>function</Term> to be performed, we
                        need the post’s updated text, which will be its{' '}
                    ...
                    <p>
                        As we discussed, Caption is a component of the Post class. Therefore, when
                        we create a specific Post, we will have access to all components of that
                        class.
                    </p>
                    <p>
                        ...
                        editCaption() function is defined in the Post class, the function will have
                        direct access to the text (Caption) of that particular post.
                    </p>
                </Section.Main>
            </Section.Block>
        </Section>
