...
export default () => (
    <Section>
        <Section.Main>
            <p>
                Here is how it could be defined. Instagram consists of two main components: feed of
                posts and feed of stories.
            </p>
            <ul>
                <li>The feed of Posts consists of a Set of Posts.</li>
                <ul>
                    <li>
                        The Posts in turn are made up of: the user (profile pictures [or most recent
                        story] and username); a creation timestamp; pictures, videos, or a set of
                        pictures; ‘likes’; the caption of the post; and comments.
                    </li>
                    <ul>
                        <li>
                        ...
                        <li>
                            ...
                            story] and username); text; and (optionally) a set of likes relating to
                            the commentary (which can be responses to previous comments).
                        </li>
                    </ul>
                </ul>
                <li>
                    The feed of Stories consists of: the user; and icons from the most recent story
                    in the story set.
                </li>
                <ul>
