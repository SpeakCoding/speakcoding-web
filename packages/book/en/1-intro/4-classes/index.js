            ...
            <Section.Block>
                <Section.Main>
                    ...
                    <p>
                        ...
                        <b>class</b> of these elements (e.g. the post, comment, and user classes).
                        In programming, the definition of an entity in general terms is called{' '}
                        <b>class</b>. And specific posts and users are called{' '}
                        <b>instances of a class</b>. You can think of a class as a category of
                        things. Let’s say you have a car, a blue BMW. It belongs to the car Class.
                        The class describes general characteristics and properties of cars, but is
                        not an example of a specific car. To describe a specific car – your blue BMW
