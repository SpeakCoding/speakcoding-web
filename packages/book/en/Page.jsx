...
const chapters = [
    ...
    { prefix: 6, title: 'Libraries and how to find what you need', href: '/en/chapter-6' },
    { prefix: 7, title: 'Complex sentences', href: '/en/chapter-7' },
    ...
    { number: 12, prefix: 'Bonus', title: 'Handbook', href: '/en/handbook' }
];
