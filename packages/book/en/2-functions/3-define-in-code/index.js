        ...
        <Section>
            <Section.Main>
                ...
                <p>
                    ...
                    Nonetheless, they can be identified in code by a common characteristic, namely
                    their round brackets ().
                </p>
                <p>
                    <b>Function title</b>
                </p>
                ...
                <ul>
                    ...
                    <li>
                        In some programming languages, a colon appears after the closing round
                        bracket, and the action sequence is defined on a new, indented line.
                    </li>
                </ul>
                <p>
                ...
                <p>
                    ...
                    should be written in the same place where its <Term id='class'>class</Term> is
                    defined.
                </p>
            </Section.Main>
