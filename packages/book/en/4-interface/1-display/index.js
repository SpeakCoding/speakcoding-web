        ...
        <Section.Block>
            <Section.Main>
                ...
                <Callout>
                    ...
                    called View classes. Meanwhile, the classes responsible for interacting with
                    objects (creating, changing, or deleting them) are called the Controller. There
                    are many classes that are responsible for both the display and the interaction.
                </Callout>
                <p>
                ...
                <ul>
                    <li>
                        The View is responsible for displaying an instance of a structural class
                        (Model)
                    </li>
                    <li>The User sees the View</li>
                    <li>
                        The User interacts with the elements displayed on the screen (this
                        interaction is defined within the Controller)
                    </li>
