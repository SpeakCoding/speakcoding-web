        ...
        <Section>
            <Section.Block>
                <Section.Main hlactive narrow>
                    ...
                    <p>
                        ...
                        function), with the two standard inputs defined in the UIApplication class –
                        we inherit this class:{' '}
                        <HL color='aquamarine'>
                            instance of application of the UIApplication class
                        </HL>
                        . We also see the function didFinishLaunchingWithOptions with a set of
                        launch options – launchOptions.
                    </p>
                    <Pre>{code1}</Pre>
                    <p>
                        The function’s first step is to call User.
                        <HL color='light-sky-blue'>initCurrentUser()</HL>, which is defined in the
                        User class (in the User.swift file respectively). The function checks
                        whether the <HL color='light-sky-blue'>current user’s profile</HL> is saved,
                        and loads it into User.current (a ‘static’ component of the User class). If
                        the profile is not saved, then User.initCurrentUser(){' '}
                    ...
                    <p>
                        ...
                        <HL color='orange' inline>
                            in accordance with the screen parameters of the device running the
                            program
                        </HL>
                    ...
                    <p>
                        ...
                        <HL color='powder-blue' inline>
                            color of the screen to which the user switches when the program is
                            opened (before the required ViewController is loaded)
                        </HL>
                        .
                    </p>
                    <p>
                        The <HL color='sandy-brown'>showLoginView</HL>() function describes all the
                        actions needed to display the LogIn screen. It includes a step that places
                        the LoginView controller in the self.window.
                    ...
                    <p>
                        ...
                        displaying the bottom tab menu in our application (with the home, item
                        search, userprofile, likes, and newpost tabs), and lets the user switch
                        between the application’s main screens.
                    </p>
                    <p>
                        Later we’ll look more closely at the steps of these two functions and why we
                        need them; meanwhile remember that the{' '}
                        <b>
                            application function describes the main purpose of the AppDelegate file
                            and class, namely to define
                        </b>
                        :
                    </p>
                    <ul>
                        ...
                        <li>
                            Which controllers need to be launched for this display and interaction.
                        </li>
                    </ul>
                </Section.Main>
            </Section.Block>
            ...
            <Section.Block>
                <Section.Main hlactive narrow>
                    ...
                    <p>
                        The application can be thought of as a kind of screen in whose description
                        we can define which ViewController to display in that screen.
                    </p>
                    <p>
                        We have seen how to call the LoginView screen via the{' '}
                        <HL color='aquamarine'>showLoginView</HL> function. This function’s
                        definition follows later in the code. As you can see, in this function we
                        create an instance of <HL color='light-sky-blue'>LoginViewController</HL>.
                        By default we create this instance without an email address, and transfer
                        the completion function to it that will be executed when someone
                        successfully logs in to the system.
                    </p>
                    <Pre>{code3}</Pre>
                    <p>
                        We then create an instance of <HL color='orange'>UINavigationController</HL>{' '}
                        called <HL color='steel-blue'>loginFlowNavigationController</HL>, to which
                        we transfer our <HL color='wheat'>LoginViewController</HL> (which becomes
                        the <HL color='sandy-brown'>rootViewController</HL> of the
                        UINavigationController). The UINavigationController class makes it easier to
                        switch between screens.
                    </p>
                    <p>
                        We place the <HL color='red'>loginFlowNavigationController</HL> in our
                        window’s <HL color='sandy-brown'>rootViewController</HL>, having first set
            ...
            <Section.Block>
                <Section.Main hlactive>
                    ...
                    <p>
                        In the setupUI function, we create an instance of the UItabBarController and
                        the five tabs of the main screen’s bottom menu. We save these tabs as a set
                        – viewcontroller – in the tabbarcontrollers component. An instance of this
                        class is placed in the self.tabBarController, then in our window’s
                        self.window.rootViewController. This means that the user sees the
                        corresponding <HL color='aquamarine'>root</HL> screen in the window.
                    </p>
                    <p>
                        We’ve covered how each tab is an instance of the UINavigationController
                        class. The rootViewController component of this class contains an instance
                        of the class of one of our main ViewControllers. For example, for the first
                        tab, this is FeedViewController. We have, so to speak, "wrapped" the
                        ViewController into the NavigationController. Now to each tab we need to
                        assign a tabBarItem (an instance of the UITabBarItem class), to which we
                        then transfer two images (for when the tab is active and when it’s not), and
