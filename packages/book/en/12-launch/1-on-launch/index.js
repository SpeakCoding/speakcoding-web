    ...
    <Section>
        ...
        <Section.Block>
            <Section.Main narrow>
                ...
                <p>
                    This function will typically contain descriptions of the steps required to
                    launch apps and display the main views that the user should see on screen when
                    first interacting with the program. This can be the ‘show login’ function or the
                ...
                <ul>
                    <li>
                        The class that inherits the App class from the standard library Foundation.
                        To make it easier for the compiler to find where to read the code, this
                        class needs to be tagged @main.
                    </li>
                    <li>
                        The class that inherits the UIAppDelegate class from the standard library
                        Foundation. This class needs to be tagged @UIApplicationMain. The class
                        needs to contain a description of the application function used to start the
                        program.
                    </li>
                </ul>
                <p>
