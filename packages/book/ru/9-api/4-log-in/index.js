            ...
            <Section.Block>
                <Section.Main>
                    ...
                    <p>
                        ...
                        информация о профиле: посты, читатели (фоловеры), лайки, комментарии. Кроме
                        того, устройство (клиент) сохранит информацию об этом пользователе -
                        кэширует этого пользователя - в свою базу данных, чтобы потом передать на
                        сервер.
                    </p>
                    <p>
