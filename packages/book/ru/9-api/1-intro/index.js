            ...
            <Section.Block>
                <Section.Main>
                    ...
                    <p>
                        ...
                        , бывают трех типов: GET - запрос для чтения информации, POST - для создания
                        или изменения объектов, DELETE - для удаления. Чтобы сообщить серверу, с
                        каким именно объектом или списком объектов мы хотим работать, каждый запрос
                        будет содержать “путь к объекту”. Например, для чтения информации о
                        пользователе с id - 1 - мы используем путь “user/1”. А для чтения набора его
                        постов “user/1/posts”.
                    </p>
                    <p>
