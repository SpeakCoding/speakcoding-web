...
export default () => (
    <>
                ...
                <Section.Main>
                    <Grid>
                        ...
                        <Grid.Cell border='right' hlactive>
                            Например, функция Sign up, которую мы видим на соответствующем экране в
        ...
        <Assignment number={25} href='#'>
            В ServerAPI.swift, найдите функцию, отвечающую за отправку запроса о создании поста на
            сервер. Перечислите словами (назовите) и запишите входящие этой функции. <br />
            Во временной переменной requestParameters мы сохраняем составляющие поста в виде,
            который можно записать как строку. Перечислите словами, какие составляющие поста мы в
            ней сохраняем?
        </Assignment>
    </>
);
