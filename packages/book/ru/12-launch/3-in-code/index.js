        ...
        <Section.Main hlactive narrow>
            ...
            <p>
                ...
                <HL color='steel-blue' inline={3}>
                    окно основного, “корневого” окно интерфейса - window
                </HL>{' '}
            ...
            <p>
                ...
                надо совершить для отображения в нашем окне экрана LogIn. В частности, она включает
            ...
            <p>
                ...
                home, item search (поиск юзеров), userprofile, likes и newpost) и позволяет
            ...
            <p>
                <b>то, какие экраны при взаимодействии с программой пользователь увидит первыми,</b>
            </p>
            <p>
                <b>и какие контроллеры нужно запустить для этого отображения и взаимодействия.</b>
            </p>
        </Section.Main>
    </Section>
);
