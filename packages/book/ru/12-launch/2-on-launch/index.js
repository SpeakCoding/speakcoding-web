        ...
        <Section.Block>
            <Section.Main narrow>
                <p>
                    ...
                    (FeedViewController). Чтобы сделать это, мы создадим экземпляр стандартного
                    класса UITabBarController, укажем для него пять основных view controllers, и
                    сохраним этот экземпляр как основной view для нашего окна.
                </p>
                <p>
