    ...
    <>
        ...
        <Section>
            <Section.Main>
                ...
                <Achievement>
                    <h2>New skill!</h2>
                    Теперь ты сможешь сделать структурное описание своей будущей программы более
                    подробным и осмысленным. Для всех составляющих, которые ты опишешь, ты сможешь
                    добавить класс и название, в полной мере описав “скелет” будущего продукта.
                </Achievement>
            </Section.Main>
            <Section.Side />
        </Section>
