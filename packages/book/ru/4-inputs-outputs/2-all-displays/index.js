                ...
                <Section.Main narrow>
                    ...
                    <p>
                        ...
                        <i>
                            ...
                            <Expand.Control htmlFor='2-2-1'>
                                <Button variant='rounded'>как ⤴︎</Button>
                            </Expand.Control>
                    ...
                    <p>
                        ...
                        <Expand.Control htmlFor='2-2-2'>
                            <Button variant='rounded'>в классах отображения ⤴︎</Button>
                        </Expand.Control>{' '}
                        мы перечисляем{' '}
                        <i>
                        ...
                        : создавать новый Post, редактировать username в своем аккаунте или лайкать
                        комментарий.
                    </p>
                    <p>
