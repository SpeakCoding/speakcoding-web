            ...
            <Section.Main>
                <Expand id='5-3-3'>
                    <Section.Block>
                        <Section.Main narrow>
                            <p>
                                После создания аккаунта на Github вы можете создать репозиторий
                                любого вашего проекта. Чтобы создать новый репозиторий на github, мы
                                должны вначале придумать для него имя. Все названия внутри одного
                                аккаунта должны быть уникальными.
                            </p>
                            <p>
                            ...
                            <p>
                                ...
                                нужно привязать ее к репозиторию на сервере, т.к. только после этого
                                серверная копия начинает следить за обновлениями кода. Она не
