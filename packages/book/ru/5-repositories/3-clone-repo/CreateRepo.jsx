                ...
                <Expand id='5-3-3'>
                    <Section.Block>
                        <Section.Main narrow>
                            ...
                            <p>
                                Предствим, что вы создали пустой репозиторий, в котором пока
                                находится только один файл - Readme.md. Когда вы создаете локальную
                                папку с кодом на своем устройстве, вам нужно привязать ее к
                                репозиторию в онлайн-хранилище, как вы помните, только после этого
                                онлайн копия начинает следить за обновлениями кода. Она не
                                обновляется автоматически, вы можете выбрать, какие изменения
                                переносить. Синхронизацию между онлайн-версией и локальным проектом
                                тоже удобно вести через GitHub Desktop. Из изменений в коде, будь то
                                в облачном хранилище или в вашей локальной копии, формируется новая
                                “версия”/новая ветка кода, commit. С помощью GitHub Desktop вы
                                можете “откатиться” до нужной версии, в случае если после добавления
                                новой функции программа перестала работать.
                            </p>
                            <p>
