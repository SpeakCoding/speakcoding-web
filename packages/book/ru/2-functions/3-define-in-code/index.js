        ...
        <Section>
            <Section.Main>
                ...
                <p>
                    ...
                    func/function/def/;. Иногда перед названием ничего не пишется, но по структуре
                    блока вы можете понять, что перед вами функция.
                </p>
                <p>
                ...
                <p>
                    ...
                    функции. Этот блок кода в фигурных скобках называют еще телом функции. Обычно
                    его легко выделить относительно остального текста кода
                </p>
                <ul>
                    <li>
                ...
                <p>
                    ...
                    записывается там же, где мы описываем сам <Term id='class'>класс</Term>. Нужно
                    помнить об этом при написании <Term id='function'>функций</Term>.
                </p>
            </Section.Main>
            <Section.Side>
                <Lottie.ScrollBox>
