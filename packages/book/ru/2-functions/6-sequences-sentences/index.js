        ...
        <Section>
            <Section.Main>
                ...
                <p>
                    ...
                    <Term id='sentence'>предложении</Term>. В языках программирования которые
                    появились 20-30 лет назад <Term id='sentence'>предложения</Term> отделялись друг
                    от друга; в более современных языках для этого используется просто новая строка,
                    как если бы мы нажали ENTER в тексте.
                </p>
                <p>
