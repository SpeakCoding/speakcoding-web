    ...
    <>
        ...
        <Section.Block>
            <Section.Main hlactive narrow>
                ...
                <p>
                    У этой функции два входящих параметра: имя таблицы “users”, а также “closure”
                    функция. “Closure” - это функция, которая будет использована внутри
                    create_table. В данном случае она поможет уточнить некоторые параметры таблицы.
                    Для того, чтобы добавить определение “closure” функции, мы используем ключевое
                    слово “do”, после которого в | | пишем вводную table_users, экземпляр
