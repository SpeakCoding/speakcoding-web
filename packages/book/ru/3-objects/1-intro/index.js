        ...
        <Section.Main>
            <InterceptorView onEnter={onEnter} onExit={interceptor.close}>
                ...
                <p>
                    ...
                    нового пользователя. В этот же класс отображения мы добавим последовательность
                    шагов функции, вызывающейся при нажатии кнопки Submit. Она нужна нам, чтобы
                    информация, которую User написал в форме, сохранилась, и Инстаграм создал новый
                    профиль пользователя, используя эти данные.
                </p>
                <p>
