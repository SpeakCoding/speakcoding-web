            ...
            <Section.Block>
                <Section.Main>
                    ...
                    <p>
                        ...
                        какого-то <Term id='class'>класса</Term> или получаем новую информацию в
                        ходе выполнения функций, которую хотим позже использовать, нужно указать,
                    ...
                    <ul>
                        <li>
                            ...
                            <Term id='variables'>"переменные"</Term>.
                        </li>
                    </ul>
                </Section.Main>
                <Section.Side />
