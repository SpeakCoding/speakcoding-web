        ...
        <Section>
            <Section.Main>
                ...
                <p>
                    ...
                    разобрались, для чего нам нужны <Term id='function'>функции</Term>. Компьютер и
                    программы выполняют только те действия, которые мы для них описываем. Поэтому,
                    когда мы создаем новый <Term id='instance'>объект</Term> какого-то{' '}
                    <Term id='class'>класса</Term>или получаем новую информацию в ходе выполнения
                    функций, которую хотим позже использовать, нам нужно указать, что мы хотим эту
                    информацию сохранить. В противном случае, к следующему же предложению (строке
                    кода) она перестанет существовать, и мы не сможем обратиться к этим объектам в
                    коде.
                </p>
                <p>
                ...
                <Grid cols='36% 1fr'>
                    ...
                    <Grid.Cell border='right'>
                        При сохранении информации в переменную (контейнер) мы должны придумать для
                        нее{' '}
                ...
                <ul>
                    <li>
                        Объекты классов (например, конкретный экземпляр Like), которые записаны как
                        составляющие какого-то объекта другого класса (например, в Set of Likes
                        какого-то конкретного Post), будут сохранены, пока хранится этот объект
                        другого класса (этот экземпляр Post).
                    </li>
                </ul>
                <Grid cols='36% 1fr'>
                    <Grid.Cell border='right bottom'>
                    ...
                    <Grid.Cell border='right' dense='top'>
                        Добавили newLike в составляющую Likes поста (эта составляющая имеет класс
                        Набор Лайков - Set of Likes).
                    </Grid.Cell>
                    <Grid.Cell dense='top'>
                        <Code value={code23} />
                    </Grid.Cell>
                ...
                <p>
                    ...
                    (временные контейнеры) можно сравнить с отдельными главами во время написания
                    романа. После того, как они сложились в единое повествование, мы перестаем
                    думать об этих отдельных предложениях. Но мы всегда можем их найти на конкретной
                    странице.
                </p>
            </Section.Main>
        </Section>
