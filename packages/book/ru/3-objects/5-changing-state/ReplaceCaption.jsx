        ...
        <Section.Block>
            <Section.Main narrow>
                ...
                <p>
                    ...
                    Т.к. <Term id='instance'>экземпляр класса</Term> содержит все{' '}
                ...
                <p>
                    ...
                    текст поста, т.е. он будет являться ее <Term id='input'>вводной</Term>, а сама{' '}
                    <Term id='function'>функция</Term> выглядит как последовательность следующих
                    действий:
                </p>
            </Section.Main>
        </Section.Block>
