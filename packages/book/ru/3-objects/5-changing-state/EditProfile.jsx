            ...
            <Section.Main>
                <InterceptorView onEnter={onEnter} onExit={onExit}>
                    ...
                    <p>
                        ...
                        можем менять их состояние. Например, когда мы создали профиль пользователя
                        конкретного юзера, мы можем менять его имя. Это можно делать напрямую,
                        изменяя <Term id='component'>составляющие объекта</Term>, или через{' '}
                    ...
                    <p>
                        ...
                        пользователя newUsernameField и кнопка Save. Форма хранит{' '}
                        ...
                        пользователя (объекта класса User).
                    </p>
                    <ul>
                        <li>
