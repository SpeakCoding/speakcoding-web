                    ...
                    <Section.Block>
                        <Section.Main narrow>
                            ...
                            <p>
                                ...
                                обращение к другим сквозным переменным, нужно удалить его, чтобы не
                                увеличивать память. Большинство объектов удаляется самостоятельно,
                                но иногда вам потребуется функция deinit. Ее примеры мы рассмотрим
