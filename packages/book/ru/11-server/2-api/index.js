        ...
        <Section>
            <Section.Main narrow>
                ...
                <p>
                    ...
                    чуть позже), все эти действия могут произвести стандартные функции, достаточно
                    только указать “пути” (на какие точные URL серверная программа должна
                    реагировать) и сами действия.
                </p>
