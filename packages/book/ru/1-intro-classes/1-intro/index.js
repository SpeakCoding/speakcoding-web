    ...
    <Section>
        ...
        <Section.Block>
            <Section.Main>
                ...
                <p>
                    Человеческий язык очень богатый. Активный словарный запас любого из нас на
                    родном языке включает больше <b>10&nbsp;000&nbsp;слов</b>. Можно сказать, что
                    язык программирования более примитивный. Слова в нем более емкие, точные, что
                    позволяет сделать повествование насыщенным, обходясь меньшим количеством знаков.
                </p>
                <p>
                ...
                <p>
                    Если мы попробуем для начала описать словами то, на что смотрим, а затем
                    перепишем этот повествовательный текст в виде структуры, она отдаленно станет
                    напоминать код. Спустя еще несколько этапов станет очевидно, что язык
                    программирования очень похож на любой из человеческих языков, только намного
                    проще. Любой язык программирования включает меньше <b>1000&nbsp;слов</b>.
                </p>
                <p>
                ...
                <p>
                    Вначале нам нужно научиться читать текст и разбираться в его структуре. Это один
                    из основных навыков программирования. Каковы основные <b>“части речи”</b> в этом
                    языке?
                </p>
                ...
                <Callout>
                    ...
                    «правильного» варианта записи структуры существующей или будущей программы, но
                    есть некая логика, которая, мы верим, сформируется у вас по мере обучения.
                </Callout>
            </Section.Main>
