        ...
        <Section>
            <Section.Main>
                ...
                <p>
                    ...
                    , из которых будут состоять все конкретные посты (все экземпляры) этого класса.
                    У <Term id='component'>составляющей</Term> есть{' '}
                ...
                <p>
                    ...
                    машины нет мышления. То есть мы всегда описываем “шаблон” в полной мере, даже
                    если не в каждом частном случае все ее элементы будут выполняться.
                </p>
                <p>
        ...
        <Section>
            <Section.Main>
                ...
                <p>
                    ...
                    <Term id='property'>характеристика</Term> Цвет. При составлении ее описания, мы
                    скажем это так, будто у Книги есть <Term id='component'>составляющая</Term> Цвет
                    (класса Цвета). Если так удобнее, можете сначала, для себя, записать их
                    отдельно, а позже, когда вы перепишите их на языке программирования, их запись
                    будет такой же, как у других <Term id='component'>составляющих</Term> класса.
                </p>
            </Section.Main>
            <Section.Side>
                <Section.Sticky center>
