    ...
    <>
        <Section>
            ...
            <Section.Block>
                <Section.Main narrow>
                    <p>
                        Давайте посмотрим на еще один пример - Venmo. Это социальный сервис обмена
                        быстрыми платежами. Его основным элементом, “основной” составляющей будет
                        транзакция. Вот как могло бы выглядеть его описание в структурном виде:
                    </p>
                    <Structure>
                    ...
                    <p>
                        ...
                        структурного описания, мы должны ориентироваться на то, вокруг чего
                        построена программа - наборов аудиофайлов, которые можно сохранять,
                        объединять в наборы (альбомы), платежей, переходящих от пользователя к
                        пользователю, или сообщений, которыми мы обмениваемся. Мы поговорим об этом
                        еще раз в описании задания ниже.
                    </p>
                </Section.Main>
            </Section.Block>
        </Section>
