...
export default () => (
    <>
        <Section>
            <Section.Block>
                <Section.Main narrow>
                    ...
                    <p>
                        <b>Например</b>, если мы хотим сохранить конкретный пост, то у нас не будет
                    ...
                    <ul>
                        <li>
                            ...
                            из чего он состоит (текст комментария,{' '}
                            <HL color='orange' active>
                                какой пользователь его оставил
                            </HL>
                            , к какому посту)
                        </li>
            ...
            <Section.Block>
                <Section.Main narrow>
                    <p>
                        ...
                        отображаться в базах данных, но, так как название классу дают программисты,
        ...
        <Section>
            <Section.Main narrow>
                <p>
                    Для объектов каждого класса мы должны будем добавить функцию, которая опишет
                    необходимые шаги для записи в/чтения из баз данных всех составляющих конкретного
                    объекта. Мы поговорим об этом подробнее позже.
                </p>
                <p>
