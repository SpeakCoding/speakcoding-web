                ...
                <Section.Main narrow>
                    ...
                    <ol>
                        <li>
                            ...
                            локальной памяти. Мы можем хранить данные в локальном хранилище клиента
                            - в памяти телефона/компьютера. Данные в этом случае сохраняются и будут
                            доступны только на этом устройстве. Когда приложение выключается, мы их
                            не теряем. Каждый раз программа как бы заново “создает” конкретные
                            посты/пользователей и т.д из той информации, которая была сохранена в
                            локальном хранилище.
                        </li>
                        <li>
                            Можно хранить данные на сервере или в “облаке” (онлайн-хранилище), чтобы
                            не потерять их вместе с устройством и, при необходимости, обмениваться
                    ...
                    <p>
                        ...
                        его имя, уникальный номер его аккаунта и картинка профиля.
                    </p>
                    <p>
                    ...
                    <p>Пример способа записи поста в виде строки:</p>
                    <Pre>
                        {
