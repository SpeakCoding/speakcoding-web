    ...
    <>
        <Section>
            ...
            <Section.Block>
                <Section.Main narrow>
                    <p>
                        Вы могли заметить, что кроме <b>слов, определяющих тип запроса</b> (INSERT,
                        UPDATE, SELECT, DELETE), в запросах также встречаются ключевые{' '}
                        <b>слова-условия</b> запросов (WHERE, SET и т.д. ). Исторически и те, и
                        другие пишутся большими буквами, чтобы визуально отличать их от названий
                        таблиц и колонок. Для базы данных же все равно, в каком регистре вы будете
                        их указывать. Выбор <b>слов-условий</b> зависит от <b>типа</b> запроса,
                        который вы описываете. Существуют отдельные курсы и списки литературы,
                        посвященные работе с базами данных, но для общего понимания вам достаточно
                        знать четыре основные команды, которые позволят вам работать с данными в
                        таблицах:
                    </p>
                    <ol>
