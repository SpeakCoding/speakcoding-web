        ...
        <Section>
            <Section.Block>
                <Section.Main narrow>
                    ...
                    <p>
                        Для каждой составляющей интерфейса нужно задать ее составляющие и
                        характеристики, касающиеся ее отображения, например: размер кнопки, картинка
            ...
            <Section.Block>
                <Section.Main narrow>
                    ...
                    <Expand id='4-5-1'>
                        <p>
                            Картинка поста AsynchronousImageView, в свою очередь, имеет такое
                            описание:
                        </p>
                        <ul>
                            <li>
                    ...
                    <Grid>
                        ...
                        <Grid.Cell border='right' hlactive>
                            ...
                            <p>
                                ...
                                классе UIControl есть ссылка на упрощенный класс Event, в котором
                                как составляющие перечислены действия пользователя, на которые могут
