            ...
            <Section.Block>
                <Section.Main narrow>
                    ...
                    <p>
                        ...
                        составляющей объекта. Т.е. в файлах типа View в стандартном классе UIButton
                        уже заданы функции, в которых мы можем вызвать функцию, которая должна быть
                        выполнена при том или ином событии. Эту передаваемую функцию мы описываем
                        здесь же в классе PostFeedView. Посмотрите на пример:
                    </p>
                </Section.Main>
            </Section.Block>
            <Section.Block>
                            ...
                            <p>
                                ...
                                <Hint>
                                    ...
                                    <Hint.Tooltip>
                                        ...
                                        обычно имеем дело только с функциями классов. Т.е вы можете
                                        не знать, что у кнопки есть составляющая toggleLike, где
                                        хранится описание нужной вам функции, но вы можете начать
                                        писать название необходимой вам функции и, если она описана
                                        в этом классе, редактор кода подставит ее автоматически. В
                                        этом случае функция, переданная как параметр, по сути
                                        является объектом - переменной с которой мы будем
                                        взаимодействовать.
                                    </Hint.Tooltip>
                                </Hint>
                                .
