        ...
        <Section.Block>
            <Section.Main narrow>
                ...
                <p>
                    ...
                    стандартной функцией класса <b>ActiveRecord</b> - has_many (т.к. у каждого
            ...
            <Section.Main>
                <Expand id='10-4-1'>
                    <Section.Block>
                        <Section.Main narrow>
                            <p>
                                С фоловерами дела обстоят сложнее, т.к. и владелец аккаунта, и те,
                                кто его читают, принадлежат к одному классу User.
                            </p>
                        </Section.Main>
                    </Section.Block>
                    ...
                    <Section.Block>
                        <Section.Main hlactive narrow>
                            <p>
                                В таблице followship, куда сервер сохранит информацию о фоловерах
                                конкретного пользователя, каждому "
                                <HL color='steel-blue'>follower_id</HL>" будет соответствовать
                                user_id пользователя, читающего этот аккаунт. А{' '}
                                <HL color='sandy-brown'>followee_id</HL> - user_id владельца
                                аккаунта.
                            </p>
                            <p>
                            ...
                            <Pre>{code1}</Pre>
                            <p>
                                Каждая подписка на аккаунт - это добавление записи в этой таблице.
                                Каждая отписка - удаление записи в этой таблице. Это many-to-many
                                связь таблицы users c самой с собой через таблицу followships.
                            </p>
                            <p>
                    ...
                    <Assignment number={27} href='#'>
                        ...
                        пользователем и другими model классами, опишите их простыми словами. <br />
                        Также найдите все функции, которые мы определяем для этого класса (User), и
                        напишите простыми словами, что, как вам кажется, эти функции делают.
                    </Assignment>
                </Expand>
            </Section.Main>
        </Section.Block>
