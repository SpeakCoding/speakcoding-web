    ...
    <Section>
        <Section.Block>
            <Section.Main narrow>
                <h1>Абзацы</h1>
                <p>
                    В коде, как и в тексте, несколько подряд идущих предложений, имеющих общий
                    контекст, можно выделить в{' '}
        ...
        <Section.Block>
            <Section.Main narrow>
                ...
                <p>
                    Непосредственно перед началом <Term id='paragraph'>абзаца</Term> в коде (перед
                    фигурной скобкой) может быть написано ключевое слово (аналогия в языке -
                    “подчинительные союзы” - если, то и т.д.), что будет задавать специальные
                    характеристики этому абзацу.
                </p>
            </Section.Main>
        </Section.Block>
