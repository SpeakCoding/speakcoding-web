        ...
        <Section.Block>
            <Section.Main narrow>
                ...
                <p>
                    ...
                    секцию комментариев, если их нет, то секция не отображается.
                </p>
            </Section.Main>
        </Section.Block>
            ...
            <Section.Main>
                <Grid>
                    ...
                    <Grid.Cell border='right bottom' hlactive>
                        ...
                        <HL color='light-sky-blue'>поста</HL>”: <br />
                        <HL color='orange'>
                            Если количество комментариев в Set of Comments больше 0, выполнить
