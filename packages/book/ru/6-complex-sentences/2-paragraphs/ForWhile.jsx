    ...
    <>
        <Section.Block>
            <Section.Main narrow>
                ...
                <p>
                    <b>Например</b>, мы можем хотеть вывести на экран все комментарии к какому-то
                    посту. Тогда действия, которые необходимы для того, чтобы вывести один из
                    комментариев, необходимо повторить для всех комментариев, содержащихся в Set of
                    Comments конкретного поста.
                </p>
                <p>
                ...
                <p>
                    <b>while</b>, если условие (логическое выражение) описанное в скобках верно,
