    ...
    <Section>
        <Section.Main narrow>
            ...
            <p>
                ...
                объектов в Наборе ограниченно некоторым числом, например, десятью объектами, то, при
                создании <Term id='set'>набора</Term>, это число вписывается в эти квадратные
                скобки:
            </p>
            <Pre>var comments = Comment[10];</Pre>
            <p>
                Порядковый номер объекта из этого набора может пригодится вам для временного
                хранения объекта в наборе или чтения конкретного объекта из этого набора.
            </p>
            <p>
                В программировании счет элементов в наборе начинается с 0. Т.е. первый элемент будет
                иметь порядковый номер 0, второй - 1, третий - 2 и далее по списку. Представим, что
                в твоем IG аккаунте есть 10 постов. В таком случае, максимальное количество объектов
                в этом Наборе - 10.
            </p>
            ...
            <p>
                ...
                Инстаграм вам всегда будет показывать последнюю Story в наборе, т.к она наиболее
                свежая:
            </p>
            <Pre>
